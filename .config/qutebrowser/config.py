...
foreground = '#afafd7' # light purple
background = '#1c1c1c' # black
color1     = '#1c1c1c' # black
color2     = '#d7875f' # orange
color3     = '#87afd7' # light blue
color4     = '#5bb955' # green
color5     = '#af87af' # purple
color6     = '#5f5f87' # dark purple
color7     = '#659ea2' # teal
color8     = '#f0ecfe' # white
...
## Type: QtColor
c.colors.tabs.selected.even.fg = color3
...
## Type: QtColor
c.colors.tabs.selected.odd.fg = color3
...
c.url.start_pages = ['http://www.doublepressure.com/']
